...
export default class Gallery extends PureComponent {
    static propTypes = {
        ...
        enableScrollOnScale: PropTypes.bool
    };
    ...
    shouldScrollViewPager(evt, gestureState) {
        ...
        if (this.isCurrentImageScaled() && !this.props.enableScrollOnScale) {
            return false;
        }
    ...
    isCurrentImageScaled() {
        return this.getImageTransformer(this.currentPage).state.scale != 1;
    }
